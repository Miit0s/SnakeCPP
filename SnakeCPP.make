...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/SnakeCPP.exe
OBJDIR = obj/x64/Debug/SnakeCPP
...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/SnakeCPP.exe
OBJDIR = obj/ARM64/Debug/SnakeCPP
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
TARGET = $(TARGETDIR)/SnakeCPP.exe
OBJDIR = obj/x64/Release/SnakeCPP
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/SnakeCPP.exe
OBJDIR = obj/x86/Release/SnakeCPP
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/SnakeCPP.exe
OBJDIR = obj/ARM64/Release/SnakeCPP
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
$(OBJDIR)/Fruit.o: src/Game/Fruit.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/Snake.o: src/Game/Snake.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/Random.o: src/Tools/Random.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/EndingScene.o: src/View/EndingScene.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/GameScene.o: src/View/GameScene.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/TitleScene.o: src/View/TitleScene.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
